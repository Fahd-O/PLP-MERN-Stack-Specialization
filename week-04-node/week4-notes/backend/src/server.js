...
app.get("/", (req, res) => res.send("API is up and running... Don't fully understand what API means though"));
app.use("/api/notes", noteRouter);


const PORT = process.env.PORT || 5000;

app.listen(PORT, ()=> console.log(`API is skating on http://localhost:${PORT}`));